...
const BookCard = ({book}) => {
    return (
      ...
      {/* Add to Cart Button */}
      <button className="btn-primary w-full mt-4 cursor-pointer hover:bg-[#c4dde7] text-gray-800 py-2 rounded-xl font-semibold flex items-center justify-center gap-2 duration-200">
       Viw Details
      </button>
